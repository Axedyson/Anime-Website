...
(function (factory) {
    ...
    var Comments = {
        ...
        fetchNext: function () {
            ...
            var commentList = this.$el.find('ul#comment-list');

            if (this.$el.find("li.active").attr('data-sort-key') !== 'newest') spinner.insertBefore(commentList.first());
        ...
        highlightPings: function (commentModel, html) {
            ...
            if (html.indexOf('@') != -1) {
                ...
                $(Object.keys(commentModel.pings)).each(function (index, userId) {
                    ...
                    html = html.replace(new RegExp(pingText + "(?!\\S)", 'g'), __createTag(pingText, userId));
                });
            }
            return html;
        },
